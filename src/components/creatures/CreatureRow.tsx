...
export default function CreatureRow({ creature, isActive, onSave, onDelete }: CreatureRowProps) {
  ...
  return (
    <div className={cn(
      ...
      <button
        onClick={onDelete}
        className="p-1 rounded text-transparent group-hover:text-dnd-muted hover:!text-dnd-red transition-colors"
